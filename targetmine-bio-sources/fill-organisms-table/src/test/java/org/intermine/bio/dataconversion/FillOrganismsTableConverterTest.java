...
public class FillOrganismsTableConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    FillOrganismsTableConverter converter;
    MockItemWriter itemWriter;

    public FillOrganismsTableConverterTest(String arg) {
        super(arg);
    }
