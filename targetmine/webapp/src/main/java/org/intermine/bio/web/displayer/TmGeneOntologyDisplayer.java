...
/**
 * This displayer is modified from the original GeneOntologyDisplayer.java in InterMine 
 * to support displaying GO annotations for the Protein class 
 */
public class TmGeneOntologyDisplayer extends ReportDisplayer
{
    /**
     ...
     */
    public TmGeneOntologyDisplayer(ReportDisplayerConfig config, InterMineAPI im) {
        super(config, im);
    }
